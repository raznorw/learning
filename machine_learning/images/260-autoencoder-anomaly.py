...
datagen_anomaly = ImageDataGenerator(rescale=1./255)

# sanity check, can we load an image?  ues
with Image.open('/home/cell_images/u/Uninfected/C100P61ThinF_IMG_20150918_144104_cell_128.png') as im:
    im.show()
...
anomaly_generator = datagen_anomaly.flow_from_directory(
    '/home/cell_images/p/',
    target_size=(SIZE, SIZE),
    batch_size=batch_size,
    class_mode='input'
...
#Fit the model. 
# after 100 epochs, hadn't settled down 
# after 200 epochs, still looks like progress
#   0.003-0.0042
# after 300 epochs, still looks like progress
#   0.0022-0.003
# after 800: starting to settle, but still improving
history = model.fit(
        train_generator,
        steps_per_epoch= 500 // batch_size,
        epochs=1000, # note: was 1000, shrunk for now
...
## Can reload later with (structure + weights)
...
# Execute below section as one block instead of line-by-line
...
## This is exactly the first part of the model above
...
# NOTE: we haven't trained this model yet
...
def check_anomaly(img_path):
    ...
    if density < density_threshold or reconstruction_error > reconstruction_error_threshold:
        ...
        print(f"{img_path} is NOT an anomaly")
        
        
#Load a couple of test images and verify whether they are reported as anomalies.
import glob
para_file_paths = glob.glob('cell_images/p/Parasitized/*')
uninfected_file_paths = glob.glob('cell_images/u/Uninfected/*')
