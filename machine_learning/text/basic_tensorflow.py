...
TODO: Can we run this model on other forms of text, such as book reviews
  or blog posts, and determine if they are "positive" or "negative" in tone?
...
# unsup contains more reviews.  i'm guessing they aren't labelled so we
# aren't using them
remove_dir = os.path.join(train_dir, 'unsup')  # remove unused directory
